# Global Langlands Reciprocity — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/global-langlands-reciprocity-canonical-lane-mathlib.git
cd global-langlands-reciprocity-canonical-lane-mathlib
lake exe
lake build
```
