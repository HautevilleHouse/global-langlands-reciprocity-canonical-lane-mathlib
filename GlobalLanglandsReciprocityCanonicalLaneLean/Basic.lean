/-!
# global-langlands-reciprocity-canonical-lane Lean migration boundary
...
`GlobalLanglandsReciprocityCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "global-langlands-reciprocity-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/global-langlands-reciprocity-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Global Langlands reciprocity: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["automorphic-forms", "galois-representations", "langlands-program", "mathematical-proof", "reciprocity", "reproducibility", "local-global-compatibility", "canonical-lane", "local-to-global", "manifold-constrained"]
